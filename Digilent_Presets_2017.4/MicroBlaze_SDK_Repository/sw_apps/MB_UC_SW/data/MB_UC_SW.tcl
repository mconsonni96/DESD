proc swapp_get_name {} {
    return "LED Game for Microcontroller Preset";
}

proc swapp_get_description {} {
    return "This is a simple LED game that shows interaction with the I/O in the MicroBlaze MicroController Preset example design.  By pressing buttons you can make changes to the LED patterns that are displayed by the microcontroller.";
}
