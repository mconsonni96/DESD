/************************************************************************/
/*                                                                      */
/* PmodNAV.h    --      Driver for the Pmod NAV using SPI               */
/*                                                                      */
/************************************************************************/
...
/*  with the PmodNAV - adapted from Monica I's chipKit Lib              */
/*                                                                      */
/************************************************************************/
/*  Revision History:                                                   */
/*                                                                      */
...
void NAV_WriteRegister(PmodNAV* InstancePtr, u8 bInst, u8 bAddr, u8 bCntBytes, u8 *pData);
void NAV_ReadRegister(PmodNAV* InstancePtr, u8 bInst, u8 bAddr, u8 bCntBytes, u8 *pData);
...
//  TODO void NAV_ConfigIntForExternalIntUse(u8 bIntPin, u8 bParExtIntNo, u8 bIntGenMask, void (*pfIntHandler)(), uint8_t bActiveType, uint8_t bOutputType);
