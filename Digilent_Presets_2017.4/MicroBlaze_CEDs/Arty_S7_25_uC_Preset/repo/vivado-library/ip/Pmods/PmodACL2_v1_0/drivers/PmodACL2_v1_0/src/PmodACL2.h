...
#define ACL2_FREE_FALL_THRESH   	0x96   	//Sets free-fall detection threshold to 600mg
#define ACL2_INACT_STILL_THRESH 	0xFA 	//Sets still motion reference threshold to 1g
...
#define ACL2_SET_INACT_INTERUPT		0x20 	//Sets the inactivity interrupt to the interrupt 1 pin
