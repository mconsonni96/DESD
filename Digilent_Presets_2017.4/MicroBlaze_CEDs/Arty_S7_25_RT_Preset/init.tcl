...
proc getConfigDesignInfo {} { 
  return [dict create name {Arty_S7_25_base_rt} description {}]
}

proc getSupportedParts {} { 
  return [list spartan7{xc7s25csga324-1}]
}

proc getSupportedBoards {} { 
  return [list digilentinc.com:arty-s7-25:1.0]
}
...
proc createDesign { project_name {project_location "."} {options ""}} { 
  ...
  catch {source -notrace "$currentDir/Arty_S7_25_base_rt_design.tcl"} retString 
