...
/*  File Description:                                                   */
/*                                                                      */
/*  This demo_project initializes and uses the PmodOLED to display      */
/*  strings and show different available fill patterns.                 */
/*                                                                      */
/*  In order to properly quit the demo, a serial terminal application   */
/*  should be connected to your board over UART at the appropriate baud */
...
**
**  Errors:
**      If the demo is shut down without properly exiting, does not reinitialize properly.
**
**  Description:
