...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BYTES_PER_RX_PACKET" -parent ${Page_0}
...
proc update_PARAM_VALUE.BYTES_PER_RX_PACKET { PARAM_VALUE.BYTES_PER_RX_PACKET } {
	# Procedure called to update BYTES_PER_RX_PACKET when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BYTES_PER_RX_PACKET { PARAM_VALUE.BYTES_PER_RX_PACKET } {
	# Procedure called to validate BYTES_PER_RX_PACKET
	return true
}
...
proc update_MODELPARAM_VALUE.BYTES_PER_RX_PACKET { MODELPARAM_VALUE.BYTES_PER_RX_PACKET PARAM_VALUE.BYTES_PER_RX_PACKET } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BYTES_PER_RX_PACKET}] ${MODELPARAM_VALUE.BYTES_PER_RX_PACKET}
}
