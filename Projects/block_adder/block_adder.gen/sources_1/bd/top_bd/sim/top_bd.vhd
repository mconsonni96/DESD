...
entity top_bd is
  ...
  attribute CORE_GENERATION_INFO of top_bd : entity is "top_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of top_bd is
  ...
  end component top_bd_adder_0_0;
  ...
  signal adder_0_m_axis_TDATA : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal adder_0_m_axis_TREADY : STD_LOGIC;
  signal adder_0_m_axis_TVALID : STD_LOGIC;
...
AXI4Stream_UART_0: component top_bd_AXI4Stream_UART_0_0
     port map (
      ...
      s00_axis_tx_tdata(7 downto 0) => adder_0_m_axis_TDATA(7 downto 0),
      s00_axis_tx_tready => adder_0_m_axis_TREADY,
      s00_axis_tx_tvalid => adder_0_m_axis_TVALID
    );
adder_0: component top_bd_adder_0_0
     port map (
      aclk => clk_wiz_0_clk_out1,
      aresetn => util_vector_logic_0_Res(0),
      m_axis_tdata(7 downto 0) => adder_0_m_axis_TDATA(7 downto 0),
