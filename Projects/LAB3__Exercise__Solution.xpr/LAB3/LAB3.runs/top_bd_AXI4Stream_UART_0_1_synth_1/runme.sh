...
HD_PWD='C:/DESD/Projects/LAB3__Exercise__Solution.xpr/LAB3/LAB3.runs/top_bd_AXI4Stream_UART_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bd_AXI4Stream_UART_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bd_AXI4Stream_UART_0_1.tcl
