...
entity top_bd is
  ...
  attribute CORE_GENERATION_INFO of top_bd : entity is "top_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of top_bd is
  ...
  component top_bd_AXI4Stream_UART_0_1 is
  port (
  ...
  end component top_bd_AXI4Stream_UART_0_1;
...
AXI4Stream_UART_0: component top_bd_AXI4Stream_UART_0_1
     port map (
