...
architecture STRUCTURE of design_1 is
  ...
  signal AXI4Stream_Depacketi_0_m_axis_TREADY : STD_LOGIC_VECTOR ( 1 to 1 );
  signal AXI4Stream_Depacketi_0_m_axis_TVALID : STD_LOGIC;
  signal AXI4Stream_GPI_0_m_axis_TDATA : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal AXI4Stream_GPI_0_m_axis_TREADY : STD_LOGIC_VECTOR ( 0 to 0 );
...
AXI4Stream_Depacketi_0: component design_1_AXI4Stream_Depacketi_0_0
     port map (
      ...
      m_axis_tready => AXI4Stream_Depacketi_0_m_axis_TREADY(1),
...
AXI4Stream_GPI_0: component design_1_AXI4Stream_GPI_0_0
     port map (
      ...
      m_axis_tready => AXI4Stream_GPI_0_m_axis_TREADY(0),
...
axis_switch_0: component design_1_axis_switch_0_0
     port map (
      ...
      s_axis_tdata(31 downto 16) => AXI4Stream_Depacketi_0_m_axis_TDATA(15 downto 0),
      s_axis_tdata(15 downto 0) => AXI4Stream_GPI_0_m_axis_TDATA(15 downto 0),
      s_axis_tready(1) => AXI4Stream_Depacketi_0_m_axis_TREADY(1),
      s_axis_tready(0) => AXI4Stream_GPI_0_m_axis_TREADY(0),
      s_axis_tvalid(1) => AXI4Stream_Depacketi_0_m_axis_TVALID,
      s_axis_tvalid(0) => AXI4Stream_GPI_0_m_axis_TVALID,
