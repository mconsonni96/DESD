...
----------------------------------------------------------------------------------
--Command: generate_target bd_58cd.bd
--Design : bd_58cd
...
entity bd_58cd is
  ...
  attribute CORE_GENERATION_INFO of bd_58cd : entity is "bd_58cd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_58cd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_58cd : entity is "top_bd_system_ila_0_0.hwdef";
end bd_58cd;

architecture STRUCTURE of bd_58cd is
  component bd_58cd_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_58cd_ila_lib_0;
  component bd_58cd_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_58cd_g_inst_0;
  component bd_58cd_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_58cd_slot_0_aw_0;
  component bd_58cd_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_58cd_slot_0_w_0;
  component bd_58cd_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_58cd_slot_0_b_0;
  component bd_58cd_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_58cd_slot_0_ar_0;
  component bd_58cd_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_58cd_slot_0_r_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.0";
...
begin
  ...
  clk_1 <= clk;
  resetn_1 <= resetn;
g_inst: component bd_58cd_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_58cd_ila_lib_0
     port map (
      clk => clk_1,
