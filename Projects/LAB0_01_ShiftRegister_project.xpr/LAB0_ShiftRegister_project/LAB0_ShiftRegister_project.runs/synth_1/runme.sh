...
HD_PWD='C:/Users/nicol/Desktop/POLIMI/Didattica/Digital_Electronic_System_Design/ClassRoom LAB1/ShiftRegister/ShiftRegister.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegister_v0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftRegister_v0.tcl
