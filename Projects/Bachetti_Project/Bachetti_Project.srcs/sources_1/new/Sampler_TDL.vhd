...
entity Sampler_TDL is
	generic (
		...
		MAX_VALID_TAP_POS		:	INTEGER		:=	7;									--! Maximal position inside SampledTaps used by ValidPositionTap to extract the valid (MAX = HIGH that is LEFT attribute downto vect)
		---------------------------
