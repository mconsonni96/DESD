...
# module references:
# debouncer, debouncer, depacketizer, edge_detector, edge_detector, moving_average_filter_en, mute_controller, packetizer, volume_controller
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {212.313} \
   CONFIG.CLKOUT1_PHASE_ERROR {303.091} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {96} \
   CONFIG.CLKOUT2_JITTER {189.153} \
   CONFIG.CLKOUT2_PHASE_ERROR {303.091} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {230.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {57.000} \
  ...
  if { [catch {set volume_controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.LOWER_BOUND {-32768} \
   CONFIG.VOLUME_0DB {7} \
   CONFIG.VOLUME_MAX {15} \
 ] $volume_controller_0
  ...
  connect_bd_intf_net -intf_net depacketizer_0_m_axis [get_bd_intf_pins depacketizer_0/m_axis] [get_bd_intf_pins moving_average_filte_0/s_axis]
  connect_bd_intf_net -intf_net moving_average_filte_0_m_axis [get_bd_intf_pins moving_average_filte_0/m_axis] [get_bd_intf_pins volume_controller_0/s_axis]
  ...
  connect_bd_net -net enable_filter_0_1 [get_bd_ports sw0] [get_bd_pins moving_average_filte_0/enable_filter]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins depacketizer_0/aresetn] [get_bd_pins moving_average_filte_0/aresetn] [get_bd_pins mute_controller_0/aresetn] [get_bd_pins packetizer_0/aresetn] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins volume_controller_0/aresetn]
