...
--               c:/DESD/audio_project/audio_project.gen/sources_1/bd/audio_bd/ip/audio_bd_volume_controller_0_0/audio_bd_volume_controller_0_0_sim_netlist.vhdl
...
entity audio_bd_volume_controller_0_0_joystick_lut is
  port (
  ...
  attribute ORIG_REF_NAME of audio_bd_volume_controller_0_0_joystick_lut : entity is "joystick_lut";
end audio_bd_volume_controller_0_0_joystick_lut;

architecture STRUCTURE of audio_bd_volume_controller_0_0_joystick_lut is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_bd_volume_controller_0_0_volume_multiplier is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_bd_volume_controller_0_0_volume_multiplier : entity is "volume_multiplier";
end audio_bd_volume_controller_0_0_volume_multiplier;

architecture STRUCTURE of audio_bd_volume_controller_0_0_volume_multiplier is
...
lut_inst: entity work.audio_bd_volume_controller_0_0_joystick_lut
     port map (
      D(0) => lut_inst_n_4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_bd_volume_controller_0_0_volume_controller is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of audio_bd_volume_controller_0_0_volume_controller : entity is "volume_controller";
end audio_bd_volume_controller_0_0_volume_controller;

architecture STRUCTURE of audio_bd_volume_controller_0_0_volume_controller is
begin
multiplier_inst: entity work.audio_bd_volume_controller_0_0_volume_multiplier
     port map (
      aclk => aclk,
      aresetn => aresetn,
      joy_y(9 downto 0) => joy_y(9 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_bd_volume_controller_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    joy_y : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  attribute NotValidForBitStream of audio_bd_volume_controller_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of audio_bd_volume_controller_0_0 : entity is "audio_bd_volume_controller_0_0,volume_controller,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of audio_bd_volume_controller_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of audio_bd_volume_controller_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of audio_bd_volume_controller_0_0 : entity is "volume_controller,Vivado 2020.2";
end audio_bd_volume_controller_0_0;

architecture STRUCTURE of audio_bd_volume_controller_0_0 is
...
begin
U0: entity work.audio_bd_volume_controller_0_0_volume_controller
     port map (
      aclk => aclk,
      aresetn => aresetn,
      joy_y(9 downto 0) => joy_y(9 downto 0),
