...
--               c:/DESD/audio_project/audio_project.gen/sources_1/bd/audio_bd/ip/audio_bd_debouncer_1_0/audio_bd_debouncer_1_0_sim_netlist.vhdl
...
entity audio_bd_debouncer_1_0_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME of audio_bd_debouncer_1_0_debouncer : entity is "debouncer";
end audio_bd_debouncer_1_0_debouncer;

architecture STRUCTURE of audio_bd_debouncer_1_0_debouncer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity audio_bd_debouncer_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of audio_bd_debouncer_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of audio_bd_debouncer_1_0 : entity is "audio_bd_debouncer_1_0,debouncer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of audio_bd_debouncer_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of audio_bd_debouncer_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of audio_bd_debouncer_1_0 : entity is "debouncer,Vivado 2020.2";
end audio_bd_debouncer_1_0;

architecture STRUCTURE of audio_bd_debouncer_1_0 is
...
begin
U0: entity work.audio_bd_debouncer_1_0_debouncer
     port map (
      clk => clk,
      debounced => debounced,
