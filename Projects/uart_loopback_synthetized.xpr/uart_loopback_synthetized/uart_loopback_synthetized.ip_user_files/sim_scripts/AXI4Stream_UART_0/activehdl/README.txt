...
#
# Generated by export_simulation on Wed Mar 25 19:06:43 CET 2020
#
################################################################################
...
'-reset_run' switch to the './AXI4Stream_UART_0.sh' script.

./AXI4Stream_UART_0.sh -reset_run
...
./AXI4Stream_UART_0.sh -noclean_files

For more information on the script, please type './AXI4Stream_UART_0.sh -help'.
